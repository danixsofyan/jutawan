...
<head>
    ...
    <!-- This page CSS -->
    <!-- chartist CSS -->
    <link href="<?= base_url('assets/admin/'); ?>node_modules/morrisjs/morris.css" rel="stylesheet">
    <!--Toaster Popup message CSS -->
    <link href="<?= base_url('assets/admin/'); ?>node_modules/toast-master/css/jquery.toast.css" rel="stylesheet">
    <!-- Custom CSS -->
                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown u-pro">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark profile-pic" href="" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?= base_url('assets/admin/'); ?>images/users/0.jpg" alt="user" class=""> <span class="hidden-md-down">Admin Jutawan &nbsp;<i class="fa fa-angle-down"></i></span> </a>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="user-pro"> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><img src="<?= base_url('assets/admin/'); ?>images/users/1bdg.jpg" alt="user-img" class="img-circle"><span class="hide-menu">Mark Jeckson</span></a>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="index.html" aria-expanded="false"><i class="icon-speedometer"></i><span class="hide-menu">Dasboard Jutawan<span class="badge badge-pill badge-cyan ml-auto">1</span></span></a>
                                <ul aria-expanded="false" class="collapse">
